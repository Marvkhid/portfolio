...
export const TESTIMONIALS: Testimonial[] = [
  ...
  },
 {
  ...
  company: 'Kova Shop',
  country: '🇳🇬 Nigeria',
  text: 'Marvel handled everything for Kova Shop—from the logo and brand identity to the UI and the full-stack application. All we had to do was pitch the idea, and he brought it to life exactly how we envisioned it, even better in some areas. The process was smooth, the execution was sharp, and what we have now feels like a complete, well-built product, not just a website.',
  initials: 'KM',
  image: '/kova.png',
},
  {
    name: 'Marcus Reid',
    role: 'Gym Instructor & Fitness Coach',
    company: 'Marcus Reid Fitness',
    country: 'United State Of America',
    text: 'Marvel built my entire online presence from scratch, including a custom website and a full-stack application for my fitness coaching business. The result is a sleek, user-friendly platform that has significantly improved my client engagement and business operations. His attention to detail and understanding of my brand made the process seamless.',
    initials: 'MR',
    image: '/marcus-reid.png',
  },
    {
  name: 'JMTech',
  role: 'Owner / Scrum Master',
  company: 'JMTech',
  country: '🇳🇬 Ado-Ekiti, Nigeria',
  text: 'No hype, Marvel delivers. We had a basic setup built with plain HTML, CSS, and JavaScript, but he stepped in and completely transformed it into a modern Next.js and TypeScript application. The difference is clear, better structure, improved SEO, faster performance, and a more scalable foundation. He did not just rebuild it, he upgraded the entire experience. Straight execution, no noise.',
  initials: 'JM',
  image: '/jmtech.png',
  },
  {
